...
<head>
    ...
    <title><?php esc_html_e('Presto online · Daria AI', 'commerciale-ai'); ?></title>
    <?php wp_head(); ?>
</head>
...
<main class="coming-soon">
    <header class="coming-soon__header cai-container">
        <a class="site-branding" href="<?php echo esc_url(home_url('/')); ?>" aria-label="<?php esc_attr_e('Daria AI', 'commerciale-ai'); ?>">
    ...
    <section class="coming-soon__hero cai-container">
        <div class="coming-soon__copy">
            ...
            <p class="coming-soon__intro"><?php esc_html_e('Daria AI sta arrivando: un ambiente operativo che raccoglie le richieste, mette ordine nelle priorità e prepara il prossimo passo insieme al tuo team.', 'commerciale-ai'); ?></p>
        ...
        <div class="coming-soon__visual" aria-label="<?php esc_attr_e('Anteprima illustrativa di Daria AI', 'commerciale-ai'); ?>">
            <div class="coming-card coming-card--main">
                <div class="coming-card__bar"><i></i><i></i><i></i><span><?php esc_html_e('Daria AI', 'commerciale-ai'); ?></span></div>
    ...
    <footer class="coming-soon__footer cai-container">
        <span>© <?php echo esc_html(wp_date('Y')); ?> <?php esc_html_e('Daria AI', 'commerciale-ai'); ?></span>
