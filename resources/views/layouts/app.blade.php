    ...
    <div class="app-shell">
        <aside class="sidebar" id="sidebar">
            ...
            @if($activeRole==='owner')
                ...
                <nav class="nav" aria-label="Configurazione">
                    <a class="nav-link @if(request()->routeIs('onboarding')) active @endif" href="{{ route('onboarding') }}"><span class="nav-icon"><svg fill="none" viewBox="0 0 24 24"><path d="m5 12 4 4L19 6" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Avvio guidato @if($activeOrganization?->status==='onboarding')<span class="nav-count">!</span>@endif</a>
                    ...
                    <a class="nav-link @if(request()->routeIs('settings.mailboxes.*')) active @endif" href="{{ route('settings.mailboxes.index') }}"><span class="nav-icon"><svg fill="none" viewBox="0 0 24 24"><path d="M4 6.5h16v11H4z" stroke-width="1.8"/><path d="m5 8 7 5 7-5" stroke-width="1.8" stroke-linecap="round"/></svg></span>Email Daria</a>
                    <a class="nav-link @if(request()->routeIs('settings.whatsapp.*')) active @endif" href="{{ route('settings.whatsapp.edit') }}"><span class="nav-icon"><svg fill="none" viewBox="0 0 24 24"><path d="M6.3 18.2 5 21l3.1-1a8 8 0 1 0-1.8-1.8Z" stroke-width="1.7" stroke-linejoin="round"/><path d="M9 8.2c.4 3 2 4.6 5 5" stroke-width="1.7" stroke-linecap="round"/></svg></span>WhatsApp <span class="badge" style="margin-left:auto">BETA</span></a>
        ...
        <div class="workspace">
            ...
            <main class="container">
                ...
                @if($activeOrganization?->status==='onboarding' && !request()->routeIs('onboarding'))
                    <div class="warning">Il workspace è ancora in configurazione. <a href="{{ route('onboarding') }}">Completa l’avvio guidato</a>.</div>
                @endif
                @yield('content')
            </main>
        </div>
