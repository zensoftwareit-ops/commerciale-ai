...
<header>
    ...
    <nav><span>Super Admin</span><a href="{{ route('admin.organizations.index') }}">Clienti</a><a href="{{ route('admin.licensing') }}">Licenze</a><a href="{{ route('leads.index') }}">Software</a><form method="post" action="{{ route('logout') }}">@csrf<button>Esci</button></form></nav>
</header>
<main>
