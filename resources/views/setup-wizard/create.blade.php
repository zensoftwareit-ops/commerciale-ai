...
<form class="card" method="post" action="{{ route('setup-wizard.generate') }}" style="max-width:920px">
    ...
    <textarea name="description" rows="14" minlength="80" maxlength="10000" required placeholder="Esempio: Siamo uno studio che realizza siti web per PMI italiane. Offriamo...">{{ $description }}</textarea>
    <div class="notice">La descrizione viene inviata alle API OpenAI configurate sul server per generare la bozza. Non inserire password, chiavi API o dati personali non necessari.</div>
